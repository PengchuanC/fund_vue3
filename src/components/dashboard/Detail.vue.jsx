    ...
    setup(props) {
        ...
        const columns = [
            ...
            },
            {
                ...
                slots: {
                    default: (table) => {
                        const { row } = table;
                        const { year3 } = row;
                        return (<span style={{ color: year3 > 0 ? 'red' : 'green' }}>{numeral(year3).format('0.00')}</span>);
                    }
                },
                sortable: true
            },
            {
                ...
                slots: {
                    default: (table) => {
                        const { row } = table;
                        const { year5 } = row;
                        return (<span style={{ color: year5 > 0 ? 'red' : 'green' }}>{numeral(year5).format('0.00')}</span>);
                    }
                },
                sortable: true
            },
            {
                ...
                width: 90,
                align: 'right',
                formatter: (row) => numeral(row.cellValue).format('00.0')
            },
            {
                field: 'scale_nature',
                title: '规模属性',
...
//# sourceMappingURL=Detail.vue.jsx.map